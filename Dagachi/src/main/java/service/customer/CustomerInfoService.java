 ...
 * 
 * import dao.customer.CustomerInfoDao; import dto.CustomerInfoDto; import
 * lombok.Setter;
 * 
 * @Service public class CustomerInfoService {
 * 
 * @Autowired private CustomerInfoDao dao;
 * 
 * public int add() throws Exception { Date now = new
 ...
 * d.setCustomer_gender("wom"); d.setCustomer_Join_Date(now);
