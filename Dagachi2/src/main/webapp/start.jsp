...
<body>
		...
		<div
			...
			<div class="preloader-inner position-relative">
				...
				<div class="preloader-img pere-text">
					<img src="resources/assets/img/logo/logo_size.jpg" alt="" style="">
				</div>
			</div>
		</div>
	</div>
						...
						<div class="col-xl-10 col-lg-10 col-md-10">
							<div
								...
								<div class="header-right-btn f-right d-none d-lg-block ml-30">
									<a href="owner/loginOwnerForm" class="btn header-btn">Login</a>
								</div>
							</div>
						</div>
						<!-- Mobile Menu -->
	...
	<main>
							...
							<div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
								<div class="hero__caption">
									...
									<h1 class="cd-headline letters scale">
										사장님의 성공이 곧 <strong class="cd-words-wrapper"> <b
											class="is-visible">고객의 성공</b> <b>우리의 성공</b> <b>모두의 성공</b>
										</strong>

									</h1>
									<p data-animation="fadeInLeft" data-delay="0.1s">대기 시간을 줄여
										놓치는 손님이 없게 테이블을 꽊꽊꽊@!</p>
									<a href="owner/joinForm" class="btn hero-btn" data-animation="fadeInLeft"
										data-delay="0.5s">신규 가맹 신청 <i class="ti-arrow-right"></i></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-6 col-md-10">
						<div class="about-caption mb-50">
							...
							<p>There arge many variations ohf pacgssages of sorem gpsum
								ilable, but the majority have suffered alteration in some form,
								by ected humour, or randomised words whi.</p>
							<div class="about-btn1 mb-30">
								<a href="about.html" class="btn about-btn">Find Doctors .<i
									class="ti-arrow-right"></i></a>
							</div>
							<div class="about-btn1 mb-30">
								<a href="about.html" class="btn about-btn2">Appointment <i
									class="ti-arrow-right"></i></a>
							</div>
							<div class="about-btn1 mb-30">
								<a href="about.html" class="btn about-btn2">Emargency 1 <i
									class="ti-arrow-right"></i></a>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-12">
						...
						<div class="about-img ">
							...
							<div class="about-back-img ">
								<img src="resources/assets/img/gallery/about1.png" alt="">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-12">
						<div class="depart_ment_tab mb-30">
							...
							<ul class="nav" id="myTab" role="tablist">
								<li class="nav-item">
									<h4>
										<a class="nav-link active" id="home-tab" data-toggle="tab"
											...
											aria-selected="true"> <i class="flaticon-teeth"></i>
											Dentistry
										</a>
									</h4>
								</li>
								<li class="nav-item">
									<h4>
										<a class="nav-link" id="profile-tab" data-toggle="tab"
											...
											aria-selected="false"> <i class="flaticon-cardiovascular"></i>
											Cardiology
										</a>
									</h4>
								</li>
								<li class="nav-item">
									<h4>
										<a class="nav-link" id="contact-tab" data-toggle="tab"
											...
											aria-selected="false"> <i class="flaticon-ear"></i> ENT
											Specialists
										</a>
									</h4>
								</li>
								<li class="nav-item">
									<h4>
										<a class="nav-link" id="Astrology-tab" data-toggle="tab"
											href="#Astrology" role="tab" aria-controls="contact"
											aria-selected="false"> <i class="flaticon-bone"></i>
											Astrology
										</a>
									</h4>
								</li>
								<li class="nav-item">
									<h4>
										<a class="nav-link" id="Neuroanatomy-tab" data-toggle="tab"
											href="#Neuroanatomy" role="tab" aria-controls="contact"
											aria-selected="false"> <i class="flaticon-lung"></i>
											Neuroanatomy
										</a>
									</h4>
								</li>
								<li class="nav-item">
									<h4>
										<a class="nav-link" id="Blood-tab" data-toggle="tab"
											href="#Blood" role="tab" aria-controls="contact"
											aria-selected="false"> <i class="flaticon-cell"></i>
											Blood Screening
										</a>
									</h4>
								</li>
							...
							<div class="row align-items-center no-gutters">
								...
								<div class="col-lg-5">
									<div class="dept_thumb">
										<img src="resources/assets/img/gallery/department_man.png"
											alt="">
									</div>
								</div>
							</div>
							...
							<div class="col-lg-12">
								<div class="single-gallery mb-30">
									<div class="gallery-img big-img"
										style="background-image: url(resources/assets/img/gallery/gallery1.png);"></div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="single-gallery mb-30">
									<div class="gallery-img small-img"
										style="background-image: url(resources/assets/img/gallery/gallery2.png);"></div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="single-gallery mb-30">
									<div class="gallery-img small-img"
										style="background-image: url(resources/assets/img/gallery/gallery3.png);"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="single-gallery mb-30">
									<div class="gallery-img small-img"
										style="background-image: url(resources/assets/img/gallery/gallery4.png);"></div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="single-gallery mb-30">
									<div class="gallery-img small-img"
										style="background-image: url(resources/assets/img/gallery/gallery5.png);"></div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="single-gallery mb-30">
									<div class="gallery-img big-img"
										style="background-image: url(resources/assets/img/gallery/gallery6.png);"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="single-testimonial text-center">
						...
						<div class="testimonial-caption ">
							<div class="testimonial-top-cap">
								<img src="/resources/assets/img/gallery/testimonial.png" alt="">
								<p>“I am at an age where I just want to be fit and healthy
									our bodies are our responsibility! So start caring for your
									body and it will care for you. Eat clean it will care for yout
									hard.”</p>
							</div>
							<!-- founder -->
							<div
								...
								<div class="founder-img">
									<img src="/resources/assets/img/gallery/Homepage_testi.png"
										alt="">
								</div>
		...
		<div class="contact-form-main">
			...
			<div class="from-left d-none d-lg-block">
				<img src="resources/assets/img/gallery/contact_form.png" alt="">
			</div>
		</div>
		<!-- Contact form End -->
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="single-blogs mb-30">
							...
							<div class="blogs-cap">
								...
								<h4>
									<a href="blog_details.html">Amazing Places To Visit In
										Summer</a>
								</h4>
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="single-blogs mb-30">
							...
							<div class="blogs-cap">
								...
								<h4>
									<a href="blog_details.html">Developing Creativithout Losing
										Visual</a>
								</h4>
								<a href="blog_details.html" class="read-more1">Read more</a>
							</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
						<div class="single-blogs mb-30">
							...
							<div class="blogs-cap">
								...
								<h4>
									<a href="blog_details.html">Winter Photography Tips from
										Glenn</a>
								</h4>
								<a href="blog_details.html" class="read-more1">Read more</a>
							</div>
	...
	<footer>
		...
		<div class="footer-area section-bg"
			data-background="resources/assets/img/gallery/footer_bg.jpg">
			<div class="container">
							...
							<div class="single-footer-caption mb-50">
								<div class="footer-tittle">
									...
									<div class="footer-pera">
										<p class="info1">Lorem igpsum doldfor sit amet, adipiscing
											elit, sed do eiusmod tempor cergelit rgh.</p>
										<p class="info1">Lorem ipsum dolor sit amet, adipiscing
											elit.</p>
									</div>
								</div>
							</div>
