...
<label>제목</label>
<input type="text" name="customer_WriteTitle" value="${c_view.customer_WriteTitle}"/><br />

<label>작성자</label>
<input type="text" name="customer_Name" value="${c_view.customer_Name}"/><br />

<label>내용</label>
<textarea cols="50" rows="5" name="customer_Content" maxlength="1000">
${c_view.customer_Content}</textarea><br />
