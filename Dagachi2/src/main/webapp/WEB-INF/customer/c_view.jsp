...
<body>
	<form method="post" role="form">
		<label>제목 : </label> ${c_view.customer_WriteTitle}<br>
		<br>
...
${view.customer_Name}<br><br> --%>
		...
		<br> 
		<label>내용</label><br> ${c_view.customer_Content}<br>
		<br> 
		
		<input type="hidden" name="customer_WriteNo"
		value="${c_view.customer_WriteNo}">
	...
	<div>
		...
		<script>
			...
			$("#modify_btn").click(function() {
				gle.attr("action", "c_modify");
				gle.attr("method", "get");
				gle.submit();
			});
			$("#delete_btn").click(function() {
				gle.attr("action", "c_delete");
				gle.attr("method", "get");
				gle.submit();
			});
		</script>
