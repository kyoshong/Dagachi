			...
			<c:forEach var="article" items="${list.list}">
				<tr height="30">
					...
					<td align="center" width="100"><a
						href="questionContent?num=${article.owner_writeNo}&p=${list.requestPage}">
							${article.owner_writeTitle} </a></td>

					<td align="center" width="100">${article.owner_name}</td>
					...
					<td>
						<c:if test="${article.isAnswered == false}">
							<a href="o_answerWrite?questionId=${article.owner_writeNo}">답변하기</a>
						</c:if>
					</td>
				</tr>
			</c:forEach>
