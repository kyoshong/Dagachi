...
<table class="table" width="500" border="1" cellspacing="0" cellpadding="0" align="center"> 
  ...
  <input type="button" value="글수정"
       onclick="document.location.href='o_boardupdate?num=${article.owner_writeNo}&p=${pageNum}'">
   &nbsp;&nbsp;&nbsp;&nbsp;
  <input type="button" value="글삭제"
       onclick="document.location.href='o_boarddelete?num=${article.owner_writeNo}&p=${pageNum}'">
   &nbsp;&nbsp;&nbsp;&nbsp;
