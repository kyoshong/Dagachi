...
public class OwnerReservationStatisticsController {
	...
	public String getGroupChart(Model model,@RequestParam("owner_Num") int owner_Num) throws Exception {
	...
	public String getPersonNumberChart(Model model,@RequestParam("owner_Num") int owner_Num) throws Exception {
